...
const PILLARS = [
  {
    ...
    body: `Generative AI and Expert Systems represent two complementary visions of machine intelligence — one that creates and one that reasons. My research investigates how generative models (transformers, diffusion architectures) can be coupled with structured, rule-based knowledge to produce systems that are both creative and explainable.`,
  },
  {
    id: 'evolutionary',
    title: 'Evolutionary Computing & Computational Optimization',
    body: `Many of the most important problems in engineering, logistics, and AI are NP-hard. My work in evolutionary computing focuses on designing nature-inspired metaheuristics — including genetic algorithms, swarm intelligence, and hybrid memetic methods — for large-scale combinatorial and continuous optimization.`,
  },
  {
    id: 'games',
    title: 'Games Informatics & Simulation',
    body: `Games are demanding testbeds for AI: real-time decision making, adversarial reasoning, content creativity, human-aware adaptation. My research explores procedural content generation, AI-controlled NPCs, and serious games for training, education, and policy modelling.`,
  },
]

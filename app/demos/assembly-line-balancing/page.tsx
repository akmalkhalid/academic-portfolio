    ...
    <div data-screen-label="Demo" style={s('min-height:100vh')}>
      <article style={s('max-width:900px;margin:0 auto;padding:44px 28px 80px')}>
        ...
        <p style={s('font-size:13.5px;line-height:1.6;color:#6b6560;margin:26px 0 0')}>
          See also the <a href="/demos/crowd-evacuation/" style={s('color:#16142e;font-weight:500')}>crowd-evacuation simulation</a> and the <a href="/playground/" style={s('color:#16142e;font-weight:500')}>Playground</a>.
        </p>
      </article>
    </div>
  )
